...
<body>
	...
	<div class="container">
		<fieldset>
			...
			<!-- TO DO: add action="SearchServlet"  and  method  -->
					...
					<div class="row">
						...
						<div class="col-sm-10">
							...
							<form action="DetailServlet" method="GET">
								<div class="col-sm-4">
									<button type="submit" class="btn btn-primary" name="viewMovie" value="<%=movie.getId() %>">Open</button>
								</div>
							</form>
							
							<a href="<%out.write("movie-edit?movieId="+movie.getId());%>" class="btn btn-primary">Edit</a>
							
							<a href="<%out.write("movie-delete?movieId="+movie.getId());%>" class="btn btn-primary">Delete</a>
						</div>
